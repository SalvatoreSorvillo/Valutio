...
(function () {
  ...
  function manualView() {
    ...
    return '<div class="sc-manual-controls panel"><div class="field"><label>Account View</label><select data-sc-change="account-filter"><option value="all">All</option><option value="personal"' + (session.accountFilter === "personal" ? " selected" : "") + '>Personal</option><option value="joint"' + (session.accountFilter === "joint" ? " selected" : "") + '>Joint</option></select></div>' +
      ...
      '<div class="field"><label>From category</label><select data-sc-change="from-category">' + sourceCategoryOptions(session.fromCategory) + '</select></div>' +
  ...
  function render() {
    ...
    return '<div class="sc-workspace">' +
      '<div class="panel sc-import"><div class="sc-import-head"><div><h2>Statement Categoriser</h2><p class="hint">Import bank statements, review every match, then apply the clean result to Cash Flow.</p></div><div class="sc-actions"><button type="button" class="btn" data-sc-act="edit-rules">Edit rules</button><button type="button" class="btn" data-sc-act="export-simple">Export Simple Excel</button><button type="button" class="btn" data-sc-act="export-full">Export Full Excel</button><button type="button" class="btn primary" data-sc-act="apply">Apply to Cash Flow</button></div></div>' +
